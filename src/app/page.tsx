...
export default function HomePage() {
  ...
  // Replace this with your actual forum URL
  ...
  return (
    <>
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-9">
            ...
            {/* Alternative: Always visible forum section (smaller version) */}
      ...
      <style jsx>{`
        ...
        .forum-iframe-container iframe {
          width: 125%; /* Compensate for the 0.8 scale */
          height: 750px; /* Increase height to compensate for scale */
        }
        ...
        .forum-preview-small iframe {
          width: 125%; /* Compensate for the 0.8 scale */
          height: 500px; /* Increase height to compensate for scale */
        }
        ...
        @media (max-width: 768px) {
          ...
          .forum-iframe-container iframe {
            width: 166.67%; /* Compensate for the 0.6 scale */
            height: 666px;
          }
